 ...
 *
 */
public class VBoxLayoutView extends Composite implements View {

	static interface Binder extends UiBinder<Component, VBoxLayoutView> {}
	...
	@GxtUiHandler(eventType=GxtEvent.Select, uiField={"spaced",	"multiSpaced", "alignLeft", "alignCenter",
			"alignRight","alignStretch","alignStretchmax",	"flexAllEven","flexRatio","flexStretch","packStart",
			"packCenter", "packEnd"	})
